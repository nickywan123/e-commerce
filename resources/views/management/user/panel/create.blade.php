...
@section('content')
<div>
    <h4 class="text-capitalize text-dark">Create a new panel</h4>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <select name="correspondence_state_id" id="correspondence_state_id" class="form-control text-capitalize">
                                ...
                                @if (Input::old('correspondence_state_id') == $state->id)
                                <option class="text-capitalize" value="{{ $state->id }}" selected>{{ $state->name }}</option>
                                @else
                        ...
                        <div id="billing-address">
                            ...
                            <div class="form-group">
                                ...
                                <select name="billing_state_id" id="billing_state_id" class="form-control text-capitalize">
                                    <option value="default">Please choose state</option>
                                    @foreach($states as $state)
                                    @if (Input::old('billing_state_id') == $state->id)
                                    <option class="text-capitalize" value="{{ $state->id }}" selected>{{ $state->name }}</option>
                                    @else
                                    <option class="text-capitalize" value="{{ $state->id }}">{{ $state->name }}</option>
                                    @endif
