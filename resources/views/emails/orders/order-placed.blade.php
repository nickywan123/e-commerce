...
<body class="bg-light">
    <div class="container">
        ...
        <div class="card mb-4" style="border-top: 5px solid #ff00bf;">
            <div class="card-body">
                <h4 class="text-center">Your Order Confirmation</h4>
                <h5 class="text-muted text-center">{{ $order->order_id }}</h5>
                    ...
                    <tbody>
                        <tr>
                            <td style="border-top: 0;">
                                {{ $order->product->name }} x {{ $order->product_quantity }}
                                <br>
                                @if($order->product_information["product_color_id"] != null)
                                <span class="pl-2 pr-2 pt-1 pb-1 text-capitalize">
                            ...
                            <td style="border-top: 0;" class="text-right">RM {{ $order->order_price }}</td>
                        </tr>
                        <tr>
                            <td>
                                Total
                            ...
                            <td>
                                <h4 class="text-right"><strong>RM {{ $order->order_price }}</strong></h4>
                            </td>
                        </tr>
                    </tbody>
                </table>
        ...
        <div class="text-center text-muted"><a href="">Lorem ipsum</a> · <a href="">Lorem ipsum</a></div>
    </div>
