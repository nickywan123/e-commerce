...
<div class="bg-md bg-sm">
    ...
    <div>
        <div class="card border-rounded-0 bg-bujishu-gold guests-card" style="border-radius: 10px;">
            <h5 class="text-center bujishu-gold form-card-title font-family-lato" style="border-radius: 10px;">Dealer Registration</h5>
            <ul class="nav nav-tabs nav-fill" id="myTab" role="tablist">
                ...
                <li class="nav-item">
                    <a class="nav-link register-tab-active font-family-lato" id="contact-tab" data-toggle="tab" href="#introducer" role="tab" aria-controls="contact" aria-selected="false">Introducer</a>
                </li>
            </ul>
            <div class="card-body">
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="introducer" role="tabpanel" aria-labelledby="introducer-tab">
                            ...
                            <div class="text-right">
                                ...
                                <button type="submit" class="btn next-button bjsh-btn-gradient text-right font-family-lato"><b>Sign Up</b></button>
                            </div>
                        </div>
                    </div>
                </form>
