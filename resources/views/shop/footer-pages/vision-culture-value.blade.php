...
<div class="background-image background-image-mobile">
  <div class="row">
      <div class="offset-md-5 col-md-6 mt-md-3">
          <h1 class="text-header-font-size text-title ml-1" style="color:#ffcc00;">Our Vision, Culture, Value</h1>
      </div>
  </div>
  <div class="row">
      <div class="offset-md-5 col-md-6">
          <h3 class="text-header-mobile ml-1" style="font-weight: 700;">WHO WE ARE</h3>
          <p class="text-word-size ml-1">We aspire to create a DREAM HOME for all. We strive to do our part to make life better. We provide high-quality merchandise, great value, and exceptional customer service</p>
      </div>
  </div>
  <div class="row">
      <div class="offset-md-5 col-md-6 text-word-size" >
          <p class="m-0 ml-1">At Bujishu, our mission is to build Quality & Sustainable HOME LIVING STYLE :</p>
          <ul class="pl-4 ml-1">
  ...
  <div class="row">
      <div class="offset-md-5 col-md-6 text-word-size" >
        <h3 class="text-header-mobile ml-1" style="font-weight: 700;">HOW WE WORK</h3>
        <p class="m-0 ml-1">As a Company, we strive to lead by our guiding principles and cultures:</p>
        <ul class="pl-4 ml-1">
  ...
  <div class="row">
      <div class="offset-md-5 col-md-6 text-word-size">
        <h3 class="text-header-mobile ml-1" style="font-weight: 700;">WHAT WE VALUE</h3>
        <ul class="pl-4 ml-1">
...
@media(max-width:768px){
    .background-image-mobile {
        background-image: url(/images/our-vision-culture-value/our-vision-bg-mobile-3.jpg) ;
        background-repeat: no-repeat;
        background-position: center;
        background-size: 100vw 100vh;
        width: 100vw;
