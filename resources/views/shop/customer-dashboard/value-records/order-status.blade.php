...
<div class="mt-3 hidden-sm font-family" style="min-height: 100vh; margin-right: 120px;">
    <div class="container">
        ...
        <div class="container-fluid" style="margin-top:20px;">
            <a href="/shop/dashboard/orders/index" class="orders-text-style "><strong>All
                    Orders</strong></a>
            <a href="/shop/dashboard/orders/open-orders" class="orders-text-style"><strong>Open Orders</strong></a>
            <a href="/shop/dashboard/orders/order-status" class="orders-text-style" style="border-bottom: 2px solid rgb(250, 172, 24);"><strong>Order Status</strong></a>
