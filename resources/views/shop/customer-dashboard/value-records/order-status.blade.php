...
<div class="mt-3" style="min-height: 100vh;">
    <div class="container" style="margin-top: 50px;">
        ...
        <div class="container-fluid" style="margin-top:20px;">
            <a href="/shop/dashboard/orders/index" class="orders-text-style " ><i>
                <strong>All Orders</strong></i></a>
            <a href="#" class="orders-text-style"><i><strong>Open Orders</strong></i></a>
            <a href="/shop/dashboard/orders/orders-status" class="orders-text-style" style="border-bottom: 2px solid rgb(250, 172, 24);"><i><strong>Order Status</strong></i></a>
