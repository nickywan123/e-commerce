...
<div class="hidden-sm " style="min-height: 100vh; margin-right: 120px;">
    <div >
        <div class="row">
            <div class="col-md-9 mt-4">
                <h3 style="font-size:25pt; font-weight:700;"><strong>Value Records</strong></h3>
            </div>
        ...
        <div class="container-fluid" style="margin-top:20px;">
            ...
            <a href="/shop/dashboard/orders/open-orders" class="orders-text-style">
                <strong>Open Orders</strong>
            </a>
            <a href="/shop/dashboard/orders/order-status" class="orders-text-style" style="border-bottom: 2px solid rgb(250, 172, 24);">
                            ...
                            <div class="row mb-5">
                                <div class="col-4 my-auto">
                                    <a href="/shop/product/{{ $item->product->parentProduct->name_slug}}?panel={{$item->product->panel_account_id}}">
                                        <img class="responsive-img p-1" style="height:100px;width:100px; max-width:200px;" src="{{ asset('storage/' . $item->product->parentProduct->images[0]->path . $item->product->parentProduct->images[0]->filename) }}" alt="Product Image">
                                    </a>
                                </div>
                                <div class="col-8 my-auto">
                                    ...
                                    <button class="text-capitalize bjsh-btn-gradient"><a style="color:black; text-decoration:none;" href="/shop/product/{{ $item->product->parentProduct->name_slug}}?panel={{$item->product->panel_account_id}}">
        ...
        <div class="row">
            <div class="row">
                ...
                <div class="dropdown col-4 mt-3">
                    <button class="btn btn-secondary  bjsh-btn-gradient" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="background-color:rgb(250, 172, 24); color:black;">
                        Order Status <i style="font-size: 10px;" class="fa fa-arrow-down"> </i>
                    </button>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <a style="margin-left: 10px;" href="/orders/receipt/{{$purchase->purchase_number}}">Receipt</a>
                        </div>
                    </div>
                    ...
                    <div class="row ">
                        <div class="col-12 ">
                            <a href="/shop/product/{{ $item->product->parentProduct->name_slug}}?panel={{$item->product->panel_account_id}}">
                                <img class="responsive-img p-1" style="height:300px;width:300px; max-width:100%;" src="{{ asset('storage/' . $item->product->parentProduct->images[0]->path . $item->product->parentProduct->images[0]->filename) }}" alt="Product Image">
                            </a>
                        </div>
