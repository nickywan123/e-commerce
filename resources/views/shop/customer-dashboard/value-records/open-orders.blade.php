    ...
    <div class="container">
        ...
        <div class="container-fluid" style="margin-top:20px;">
            <a href="/shop/dashboard/orders/index" class="orders-text-style "><strong>All
                    Orders</strong></a>
            <a href="/shop/dashboard/orders/open-orders" class="orders-text-style" style="border-bottom: 2px solid rgb(250, 172, 24);"><strong>Open Orders</strong></a>
                ...
                <td class="align-top" style="max-width: 400px;">
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-8 my-auto">
                            ...
                            <button class="text-capitalize bjsh-btn-gradient"><a style="color:black; text-decoration:none;" href="/payment/cashier?orderId={{$purchase->purchase_number}}">
