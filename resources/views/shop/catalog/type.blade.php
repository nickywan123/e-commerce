...
@section('content')
<div>
    {{ Breadcrumbs::render('shop.category.subcategory.type', $category, $subcategory, $type) }}
                                ...
                                <ul class="list-group">
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group-item">
                                                <a style="{{ ($childType->id == $type->id) ? 'text-decoration:underline;' : '' }}" class="text-capitalize" style="font-weight: 400;" href="/shop/category/{{ $category->slug }}/{{ $childCategory->slug }}/{{ $childType->slug }}">{{ $childType->name }}</a>
                                            </li>
                                            @endforeach
                                        </ul>
                                        @endif
