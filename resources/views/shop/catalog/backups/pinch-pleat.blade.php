...
<div class="container-fluid">
  <div class="row">
   ...
   <div class="col-6 col-md-3 text-center">
    <a href="#" id="menu1">
      <img class="product-item" src="{{asset('images/pinch-pleat-01.jpg')}}">
    </a> <br> <br>
   ...
   <div class="col-6 col-md-3 text-center">
    ...
    <a href="#" id="menu1">
      <img class="product-item" src="{{asset('images/pinch-pleat-02.jpg')}}">
    </a> <br> <br>
    <span class="text-capitalize" data-toggle="tooltip" data-placement="right" title="Lorem Ipsum y of type and scrambled it"><strong>[COMPANY NAME]</strong>
      <br>
   ...
   <div class="col-6 col-md-3 text-center">
    ...
    <a href="#" id="menu1">
      <img class="product-item" src="{{asset('images/pinch-pleat-03.jpg')}}">
    </a> <br> <br>
    <span class="text-capitalize" data-toggle="tooltip" data-placement="right" title="Lorem Ipsum y of type and scrambled it"><strong>[COMPANY NAME]</strong>
      <br>
   ...
   <div class="col-6 col-md-3 text-center">
    ...
    <a href="#" id="menu1">
      <img class="product-item" src="{{asset('images/pinch-pleat-04.jpg')}}">
    </a> <br> <br>
    <span class="text-capitalize" data-toggle="tooltip" data-placement="right" title="Lorem Ipsum y of type and scrambled it"><strong>[COMPANY NAME]</strong>
      <br>
