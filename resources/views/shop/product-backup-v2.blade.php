    ...
    <div class="container">
        <div class="row">
            <div class="col-12 hidden-md pt-1 pl-1 pr-1 mb-2">
                ...
                <h5>Sold by - {{ $panelProduct->panel->company_name }}</h5>
            ...
            <div class="col-12 col-md-8 pt-1 pl-2 pr-2">
                <div class="row hidden-sm">
                    <div class="col-12 text-md-left text-center">
                        ...
                        <h5 class="mt-1 text-muted">Sold by - <strong>{{ $panelProduct->panel->company_name }}</strong></h5>
                        <!-- <div class="text-left my-auto mt-1">
                ...
                <div class="row mt-2 text-center text-md-right">
                    <div class="col-12">
                        ...
                        <button class="btn btn-lg bjsh-btn-gradient">Checkout</button>
                    </div>
                </div>
            </div>
        </div>
