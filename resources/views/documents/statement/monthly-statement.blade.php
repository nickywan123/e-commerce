...
<head>
    ...
    <title>Bujishu - Monthly Statement</title>
    <style>
        /*!
...
<body>
    ...
    <div class="row">
        <div class="col-12">
            <h3 style="text-align:center; background-color:black; color:white;">MONTHLY SALES STATEMENT</h3>
        </div>
    </div>
    ...
    <div class="container-fluid">
            ...
            <div class="col-xs-6 pl-1 pr-1">
                <div style="border: 1px solid #000000;">
                    <table style="width:50%;">
                        <tr>
                            <td style="font-size: 9pt; font-weight: 500; padding: 6px 4px; width:60px;">
                               NAME
                            </td>
                        ...
                        <tr>
                         <td style="font-size: 9pt; font-weight: 500; padding: 4px;  width:60px;">
                              ADDRESS
                         </td>
                       ...
                       <tr>  
                        ...
                        <tr>
                            <td style="font-size: 9pt; font-weight: 500; padding: 4px;">
                                CONTACT NO.
                            </td>
                            <td style="font-size: 9pt; padding: 2px 4px; border-bottom: 1px solid #cccccc; margin: 0;">
        ...
        <div class="row" >
            <div class="col-12" >
                <h4 style="text-align:center; background-color:grey; color:black; border-style: solid;  border-color: black; ">SALES HISTORY</h4>
            </div>
        </div>
