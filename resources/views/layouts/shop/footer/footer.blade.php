<footer id="footer-content-collapse-sidebar" style="max-width:100%; overflow: hidden; border-top: 1px solid #fbcc34; padding-top: 0.5rem; background-color: #000;">
    <div class="row pl-2 pr-2">
        <div class="col-6 col-md-2 text-center text-md-left">
            ...
            <ul class="list-unstyled pr-2 pl-2 bujishu-gold font-family">
                <li>
        ...
        <div class="col-6 col-md-2 text-center text-md-left">
            <ul class="list-unstyled pr-2 pl-2">
                <li>
                    ...
                    <p class="bujishu-gold mb-1 font-family" style="font-size: 0.9rem;">
                        1.26.5,
                        <br>
                        Menara Bangkok Bank
                        <br>
                ...
                <li>
                    <p class="bujishu-gold mb-1 font-family" style="font-size: 0.9rem;">Tel: 017-582 4257</p>
                </li>
            </ul>
        </div>
        ...
        <div class="col-6 col-md-2 text-center text-md-left">
            <div style="display: flex; justify-content: start;">
                <a target="_blank" href="https://facebook.com/DelhubDigital/">
                    <span class="bujishu-gold p-2 font-family" style="font-size: 1rem;"><i class="fab fa-facebook-square"></i> Facebook</span>
                </a>
                <a href="">
                    <span class="bujishu-gold p-2 font-family" style="font-size: 1rem;"><i class="fab fa-instagram-square"></i> Instagram</span>
                </a>
            </div>
        </div>
    </div>
