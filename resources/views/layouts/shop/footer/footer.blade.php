    ...
    <div class="row pl-2 pr-2">
        <div class="col-6 offset-md-1 col-md-2 text-xs-center text-md-left mb-0">
            ...
            <ul class="list-unstyled pr-2 pl-2 bujishu-white ">
                ...
                <li>
                    <a class="bujishu-white text-font-size" href="{{route('shop.vision')}}">Our Vision, Culture, Value</a>
                </li>
                <li>
                    <a class="bujishu-white text-font-size" href="{{route('shop.wip')}}">Partner Engagement</a>
                </li>
                <li>
        ...
        <div class="col-6 col-md-2 text-xs-center text-md-left mb-0">
            ...
            <ul class="list-unstyled pr-2 pl-2 " >
                <li>
                    <a class="bujishu-white text-font-size" href="{{route('shop.bujishu.service')}}">Bujishu Service</a>
                </li>
                <li>
                    <a class="bujishu-white text-font-size" href="{{route('shop.privacy.policy')}}">Privacy Policy</a>
                </li>
                <li>
                    <a class="bujishu-white text-font-size" href="/shop/dashboard/orders/order-status">Track an Order</a>
                </li>
                <li>
