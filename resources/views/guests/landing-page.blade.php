...
<body>
    ...
    <div class="backgroundImage">
        <div class="text-right p-3">
            <a href="/register-dealer " class="btn p-2 bjsh-btn-gradient font-family-lato"><b>{{ __('BE A DEALER') }}</b></a>
        </div>
        ...
        <div class="container">
            <div class="row mb-4">
                <div class="col-12 col-md-8 offset-md-2 text-center">
                    <h2 class="bujishu-motto font-family-lato">
                        A home is made of
                        <i>
            ...
            <div class="row mt-4">
                <div class="col-12 col-md-4 offset-md-4 text-center">
                    <a href="/login " class="btn  grad2 bjsh-btn-gradient btn-small-screen font-family-lato "><b>{{ __('LOGIN') }}</b></a>
                    <a href="/register" class="btn  grad2 bjsh-btn-gradient btn-small-screen font-family-lato"><b> {{ __('SIGN UP') }}</b></a>
                </div>
            </div>
        </div>
