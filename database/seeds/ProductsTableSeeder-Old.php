...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $product->getDefaultColor()->image()->create([
            'path' => 'uploads/images/products/' . $product->slug . '/' . $product->getDefaultColor()->name_slug . '/',
            'filename' => $product->slug . '_' . $product->getDefaultColor()->name_slug . '_1.jpg'
        ]);
